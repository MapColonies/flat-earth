...
//     minPoint.longitude,
//     minPoint.latitude,
//     minPoint.longitude + tileSize,
//     minPoint.latitude + tileSize,
//   ];
// }
//
// /**
...
//  */
// export function featureToTilesCount(
...
//       `Un supported zoom levels values, min-max zoom should be [0-22] but actual [${defaultMinZoom}:${defaultMaxZoom}]`
//     );
//   }
//
//   if (defaultMinZoom > defaultMaxZoom) {
//     throw new RangeError(
//       `Illegal - defaultMinZoom[${defaultMinZoom}] is larger than defaultMaxZoom[${defaultMaxZoom}]`
//     );
//   }
//   try {
//     const targetMaxZoom =
//       feature.properties?.maxResolutionDeg !== undefined &&
//       typeof feature.properties.maxResolutionDeg === 'number'
//         ? degreesPerPixelToZoomLevel(feature.properties.maxResolutionDeg)
//         : defaultMaxZoom;
//     const targetMinZoom =
//       feature.properties?.minResolutionDeg !== undefined &&
//       typeof feature.properties.minResolutionDeg === 'number'
//         ? degreesPerPixelToZoomLevel(feature.properties.minResolutionDeg)
//         : defaultMinZoom;
//     const sanitized = snapBBoxToTileGrid(
//       bbox(feature.geometry) as BBox2d,
//       targetMaxZoom
//     );
//
...
//   } catch (error) {
//     const message = `Error occurred while trying to calculate tiles amount - encodeFootprint error: ${JSON.stringify(
//       error
//     )}`;
...
//  * @returns tile count included on provided feature and zooms ranges
//  */
// export function featureCollectionToTilesCount(
...
//       tilesTotalAmount += featureToTilesCount(
