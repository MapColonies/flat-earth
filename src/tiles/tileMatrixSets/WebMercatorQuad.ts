...
import type { TileMatrixSetJSON } from '../types';

/**
 * Tile Matrix Set Web Mercator Quad, JSON encoding - https://docs.ogc.org/is/17-083r4/17-083r4.html#toc63
 */
export const TILEMATRIXSETJSON_WEB_MERCATOR_QUAD: TileMatrixSetJSON = {
  id: 'WebMercatorQuad',
